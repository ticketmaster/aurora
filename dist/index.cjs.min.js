...
var RowWrapper$1 = styled__default.div(
    ...
    function(e) {
      return "right" === e.rowTriggerPosition ? "0" : "auto";
    },
    function(e) {
      return "left" === e.rowTriggerPosition ? "0" : "auto";
    },
    spacing.spacious
  ),
  ...
  return React__default.createElement(Consumer$1, null, function(e) {
    ...
    return i
      ? React__default.createElement(
          ...
          _extends(
            {
              isOpen: determineIfOpen(d, s, a),
              index: a,
              onOverflowClick: function() {
                u({ children: t, contentType: "mobile" }), r();
              },
              onExpandItem: l,
              onCollapseItem: o
            },
          ...
          _extends(
            {
              ...
              index: a,
              onOverflowClick: function() {
                u({ children: t, contentType: "mobile", data: n }), r();
              },
              onExpandItem: l,
              onCollapseItem: o
            },
      ...
      _createClass(t, null, [
        {
          ...
          value: function(e) {
            ...
            return {
              x: Math.min(Math.max(T, h - l / 2, I), c - T - l, E),
              y: w + i + T <= Math.min(O, z) ? w : $
            };
          }
        }
      ]),
