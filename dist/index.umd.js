(function(global, factory) {
  ...
  var PropTypes__default =
    "default" in PropTypes ? PropTypes["default"] : PropTypes;
  classNames =
    classNames && classNames.hasOwnProperty("default")
      ? classNames["default"]
      : classNames;
  ReactDOM =
  ...
  var getThemeValue = function() {
    ...
    return function() {
      ...
      var _ref$theme$themeName = _ref$theme.themeName,
        themeName =
          _ref$theme$themeName === void 0 ? "tm" : _ref$theme$themeName;
  ...
  var Wrapper = styled__default.header.withConfig({
  ...
  var ImageHeader = function ImageHeader(_ref) {
    ...
    var _backgroundImageProps = backgroundImageProps.style,
      ...
      otherBackgroundImageProps = _objectWithoutProperties(
        backgroundImageProps,
        ["style", "imageRef", "backgroundRef"]
      );
  ...
  Heading.propTypes = {
    ...
    weight: PropTypes__default.oneOf(["light", "regular", "extraBold"]),
  ...
  var CaptionContainer = styled__default.div.withConfig({
      ...
      _createClass(DisplayFor, [
        {
          ...
          value: function render() {
            ...
            var _this$props = this.props,
              ...
              children = _this$props.children;
            return React__default.createElement(Consumer$2, null, function(
              val
            ) {
  ...
  var OverflowDesktopContainer$1 = styled__default(Column).withConfig({
    ...
    return React__default.createElement(Consumer$1, null, function(value) {
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          subTitle &&
            React__default.createElement(SecondaryText, null, subTitle)
        )
      );
    });
  };
  ...
  var DrawerMenuWrapper = function DrawerMenuWrapper(props) {
    return React__default.createElement(Consumer, null, function() {
      var _ref =
        ...
        toggleDrawer =
          _ref$toggleDrawer === void 0 ? noop$2 : _ref$toggleDrawer;
  ...
  SearchInput$1.propTypes = {
    ...
    isInputVisible: PropTypes__default.bool,
  ...
  var Image$1 = styled__default.img.withConfig({
      ...
      function DeviceSizeProvider() {
          ...
          function() {
            ...
            _this.setState(function() {
              return {
                ...
                isMedium:
                  _this.mediumMedia.matches && !_this.largeMedia.matches,
        ...
        _defineProperty(
          ...
          function() {
            ...
            if (_this.smallMedia)
              _this.smallMedia.removeListener(_this.setSize);
            if (_this.mediumMedia)
              _this.mediumMedia.removeListener(_this.setSize);
            if (_this.largeMedia)
              _this.largeMedia.removeListener(_this.setSize);
        ...
        [
          {
            ...
            value: function componentDidMount() {
              ...
              this.mediumMedia = window.matchMedia(
                constants.breakpoints.medium
              );
              this.largeMedia = window.matchMedia(constants.breakpoints.large);
              this.xLargeMedia = window.matchMedia(
                constants.breakpoints.xLarge
              );
  ...
  var RadioButton = function RadioButton(_ref2) {
    ...
    return React__default.createElement(Consumer$7, null, function(_ref3) {
      var focused = _ref3.focused,
        focusSelected = _ref3.focusSelected;
      return React__default.createElement(Consumer$6, null, function(_ref4) {
  ...
  RadioButton.propTypes = {
    ...
    index: PropTypes__default.number.isRequired,
    onClick: PropTypes__default.func,
    theme: PropTypes__default.shape({
      themeName: PropTypes__default.string
    })
  };
    ...
    return React__default.createElement(Consumer$7, null, function(_ref2) {
      ...
      return React__default.createElement(Consumer$6, null, function(_ref3) {
        var selected = _ref3.selected,
          onClick = _ref3.onClick;
        var isChecked = selected.includes(value);
        return React__default.createElement(Consumer$8, null, function(_ref4) {
  ...
  var StyledChevron = styled__default(ChevronIcon).withConfig({
  ...
  DropDownGroup.propTypes = {
    ...
    onChange: PropTypes__default.func,
    placeholder: PropTypes__default.string,
    variant: PropTypes__default.number,
    label: PropTypes__default.string,
    isOpen: PropTypes__default.bool,
    keywordSearch: PropTypes__default.bool,
  ...
  var ModalContainer$1 = styled__default.div.withConfig({
  ...
  var ModalContent$1 = styled__default.div.withConfig({
    ...
    ["background-color:", ";overflow-y:auto;", ";"],
    colors.white.base,
    function(_ref9) {
  ...
  _defineProperty(Backdrop$1, "propTypes", {
    ...
    childRef: PropTypes__default.object.isRequired,
    children: PropTypes__default.node.isRequired,
    ...
    (function(_Component) {
       ...
       */
          value: function calculatePosition(_ref4) {
            ...
            var containerRight =
              offsetLeft + clientWidth - spaceFromEdge - width;
        ...
        _defineProperty(
          ...
          function() {
            ...
            if (
              ...
              _this.dimensions = _objectSpread(
                {},
                _this.dimensions,
                dimensions
              );
        ...
        [
          {
            ...
            value: function getDimensionsFromEvent(e) {
              ...
              var _parent$offsetTop = parent.offsetTop,
                offsetTop =
                  _parent$offsetTop === void 0 ? 0 : _parent$offsetTop,
                _parent$clientHeight = parent.clientHeight,
                clientHeight =
                  _parent$clientHeight === void 0
                    ? 100000
                    : _parent$clientHeight,
        ...
        _defineProperty(
          ...
          function(ready) {
            ...
            if (ready && imageRef && imageRef.current) {
              ...
              var srcAttr = backgroundRef
                ? "src"
                : getSrcAttr(imageRef.current);
  ...
  var TabItemButton = styled__default.div
          ...
          value: function componentDidUpdate() {
            if (this.state.isTabsContainerOverflows) {
              ...
              var _this$itemRefs$index = this.itemRefs[index],
                ...
                activeItemLeft =
                  _this$itemRefs$index$2 === void 0
                    ? 0
                    : _this$itemRefs$index$2;
              ...
              if (
                ...
                this.content.scrollLeft =
                  activeItemLeft - parseInt(padding, 10);
              }
            }
          }
        },
